...
import com.wellnesshub.backend.auth.AuthDtos;
...
public class UserController {
    ...
    public ResponseEntity<Map<String, Object>> getDashboard(Authentication auth) {
        ...
        if (user.getRole() == UserRole.PATIENT) {
            dashboard.put("sessionHistory", new ArrayList<>()); // Mock empty list
            dashboard.put("productOrders", new ArrayList<>()); // Mock empty list
